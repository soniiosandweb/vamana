    ...
    <>
        ...
        <div className="px-0 sm:px-5 py-2.5 flex items-center">
          ...
          <div className="w-3/4 lg:w-2/6 xl:w-1/4 flex justify-end items-center gap-2 sm:gap-5 px-2.5 flex-wrap">
            ...
            <button tabIndex='-1' className="text-xs font-semibold capitalize cursor-pointer bg-primary-yellow p-2 sm:p-2.5 rounded-md text-white" onClick={handleOpen}>Enquire Now</button>
          </div>
        </div>
      </header>
