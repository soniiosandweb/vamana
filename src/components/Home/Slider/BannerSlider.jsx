...
import banner1 from '../../../assests/images/home/banner1.jpeg';
import banner2 from '../../../assests/images/home/banner2.jpeg';
import banner3 from '../../../assests/images/home/banner3.jpeg';
            ...
            <Slider {...settings}>
                {slides.map((el, i) => (
                    <div className='w-full h-full relative overflow-hidden' key={i}>
                        <Container className='flex relative banner-slider text-white py-3 z-1'>
                            <Row>
                                <Col md={12} xl={10} className='m-auto'>
                                    <div className='flex items-center justify-center h-full flex-col gap-4 text-center'>
                                        ...
                                        <p className='text-lg sm:text-xl'>{el.subtitle}</p>
