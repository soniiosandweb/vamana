...
const Home = () => {
    return (
        <>
            <MetaData 
                title={"Luxury 3bhk & 4bhk flats in Zirakpur - Vamana Arvindam Zirakpur"} 
                description={"Discover luxury 3BHK & 4BHK flats in Zirakpur. Explore new residential projects offering modern amenities, prime locations, and elegant living spaces for your dream home."} 
